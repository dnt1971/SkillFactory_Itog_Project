...
2. Использованы методы PCA и TSNE для понижения размерности. 
3. Применены модели GaussianMixture, SpectralClustering, KMeans, AgglomerativeClustering для кластеризации регионов.
4. Классы-обертки над моделями кластеризации для pipeline.
5. Метрики Силуэта, Калински-Харабаса, Дэвиса-Болдина для оценки метрик моделей.
6. FastAPI для организации web-сервера
7. pickle для сериализации и десериализации моделей
8. Scatterpolar для визуализации данных
9. DockerHub для экспорта докер-контейнеров
...
Результат особе6нностей кластеров подробно описан [здесь](https://github.com/dnt1971/SkillFactory_Itog_Project/blob/master/03_model.ipynb) и [здесь](https://github.com/dnt1971/SkillFactory_Itog_Project/blob/master/04_model.ipynb)
...
5. Пошагово
5.1. Выполните *01_preprocessing.ipynb*<br>
5.2. Выполните *02_eda.ipynb*<br>
5.3. Выполните *03_model.ipynb*<br>
