...
7. Выгрузка в GitHub
8. Выводы и оформление работы

:arrow_up:[к оглавлению](#оглавление)

### Использованные инструменты  
1. Использованы методы PCA и TSNE для понижения размерности. 2. Применены модели GaussianMixture, SpectralClustering, KMeans, AgglomerativeClustering для кластеризации регионов.
...
6. picle для сериализации и десериализации моделей
7. Scatterpolar для визуализации данных
8. DockerHub для экспорта докер-контейнеров
9. Использован метод автоматического поиска оптимальнох параметров кластеризации.
